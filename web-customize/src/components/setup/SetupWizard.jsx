...
const SetupWizard = () => {
  ...
  return (
    <div className='setup-premium-page'>
      <div className='setup-premium-shell'>
        <div className='setup-premium-head'>
          <div>
            <span className='setup-premium-eyebrow'>{t('系统向导')}</span>
            <div className='setup-premium-title'>{t('系统初始化')}</div>
            <div className='setup-premium-subtitle'>
              {t('欢迎使用，请完成以下设置以开始使用系统')}
            </div>
          </div>
          <div className='setup-premium-progress'>
            <div className='setup-premium-progress-value'>{progress}%</div>
            <div className='setup-premium-progress-label'>
              {t('当前进度')}
            </div>
          </div>
        </div>

        <Card className='setup-premium-card'>
          ...
          <Divider className='setup-premium-divider' />

          {/* 表单容器 */}
          <Form
            className='setup-premium-form'
            getFormApi={(formApi) => {
